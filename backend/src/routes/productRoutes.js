...
router.post('/', dynamicImageUpload('products').array('images', 5), productController.createProduct);
...
router.put('/:id', dynamicImageUpload('products').array('images', 5), validateToken, authRoles("admin"), productController.updateProduct);
